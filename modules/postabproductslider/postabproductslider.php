...
class postabproductslider extends Module {
	...
	public function install() {
        ...
        Configuration::updateValue($this->name . '_items_desktop', 3);
		...
		return parent :: install()
			...
			&& $this->registerHook('Tabproductslider')
    ...
    // Hook Home
	public function hookTabproductslider($params) {
	 ...
	 $tabEffect = array();
		...
		<form action="'.$_SERVER['REQUEST_URI'].'" method="post">
                  <fieldset>
                    ...
                    <label>' . $this->l('Items Desktop: ') . '</label>
                    <div class="margin-form">
                            <input type = "text"  name="items_desktop" value =' . (Tools::getValue('items_desktop') ? Tools::getValue('items_desktop') : Configuration::get($this->name . '_items_desktop')) . ' ></input>
                    </div>
					
					 <label>' . $this->l('Items Desktop Small: ') . '</label>
                    <div class="margin-form">
                            <input type = "text"  name="items_desktop_Small" value =' . (Tools::getValue('items_desktop_Small') ? Tools::getValue('items_desktop_Small') : Configuration::get($this->name . '_items_desktop_Small')) . ' ></input>
                    </div>
                      <label>' . $this->l('Items Tablet: ') . '</label>
                    <div class="margin-form">
                            <input type = "text"  name="items_tablet" value =' . (Tools::getValue('a_items_desktop_Small') ? Tools::getValue('items_tablet') : Configuration::get($this->name . '_items_tablet')) . ' ></input>
                    </div>
					<label>'.$this->l('Items Mobile: ').'</label>
                    <div class="margin-form">
                            <input type = "text"  name="items_mobile" value ='. (Tools::getValue('items_mobile')?Tools::getValue('items_mobile'): Configuration::get($this->name.'_items_mobile')).' ></input>
                    </div>
