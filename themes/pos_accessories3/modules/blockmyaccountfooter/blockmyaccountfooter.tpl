...
<section class="footer-block col-xs-12 col-md-2 col-sm-3">
	...
	<div class="block_content toggle-footer footer-static-content">
		<ul class="bullet">
            ...
            {if $is_logged}
            	<li><a href="{$link->getPageLink('index')}?mylogout" title="{l s='Log out' mod='blockmyaccountfooter'}" rel="nofollow">{l s='Log out' mod='blockmyaccountfooter'}</a></li>
            {else}
            	<li class="last"><a class="link-login" href="{$link->getPageLink('my-account', true)|escape:'html'}" title="{l s='Login' mod='blockmyaccountfooter'}"  rel="nofollow">{l s='Login' mod='blockmyaccountfooter'}</a></li>
            {/if}
		</ul>
	</div>
</section>
