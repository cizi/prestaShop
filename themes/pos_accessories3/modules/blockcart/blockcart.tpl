...
{if !$PS_CATALOG_MODE && $active_overlay == 1}
        ...
        <div class="clearfix">
            ...
            <div class="layer_cart_cart col-xs-12 col-md-6">
                ...
                <div class="button-container">	
                    <span class="continue btn btn-default button" title="{l s='Continue shopping' mod='blockcart'}">
                        <span>
                            <i class="icon-chevron-left left"></i>{l s='Continue shopping' mod='blockcart'}
                        </span>
                    </span>
                    <a class="btn btn-default button button-medium proceed_checkout"	href="{$link->getPageLink("$order_process", true)|escape:"html":"UTF-8"}" title="{l s='Proceed to checkout' mod='blockcart'}" rel="nofollow">
                        <span>
    ...
    <div id="layer_manequine">
        <div class="clearfix">
            <div class="layer_manequine_product">
                <span class="cross" title="{l s='Close window' mod='blockcart'}"></span>
                <h2>
                    <i class="icon-ok"></i>{l s='Product addet to dressingroom' mod='blockcart'}
                </h2>
                <div class="product-image-container layer_cart_img">
                </div>
                <div class="layer_cart_product_info">
    ...
    <div class="layer_manequine_overlay"></div>
