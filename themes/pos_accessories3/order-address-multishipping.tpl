...
{if !$opc}
			<p class="cart_navigation clearfix">
				...
				{else}
					<a href="{$link->getPageLink('order', true, NULL, "step=0")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="btn btn-default button button-small"><i class="icon-chevron-left"></i>{l s='Continue Shopping'}</a>
				{/if}
