...
$image_position = filter_input(INPUT_POST, 'image_position');
$suffix = "manneq";
$extension = pathinfo($_FILES['file']['name'], PATHINFO_EXTENSION);

$file_target = '../../img/man/'.$id_leyer."-".$id_product."-".$suffix."-".$image_position.".".$extension;
$file_location_for_db = 'img/man/'.$id_leyer."-".$id_product."-".$suffix."-".$image_position.".".$extension;
...
$data = array(
    ...
    'layer' => $id_leyer,
    'front_image' => ($image_position == "front") ? 1 : 0,
);
